# Web学習プロジェクト
## プログラミング初心者のための100日間学習プログラム
このプロジェクトは、プログラミング初心者が一から学習を始めるための100日間の学習プログラムです。CursorAIで作成した教材と制作物プロジェクトを中心に学習を進めます。また、ITパスポートを習得することで、実務経験に必要な最低限のWEB知識を得て学習を進めます。
...
## 🌱 現在の学習成果
- [直近の学習状況はこちら](#-学習状況)
- このリポジトリで作成した[演習・制作物](#-このリポジトリで作成した演習制作物)はこのページの最下部にまとめています。
- この100日間で実施した制作プロジェクトは以下リンクをご覧ください。
  - [カウンターアプリ](https://github.com/rin5uron/counterapp-collection): 様々な内容のカウンターアプリを作りました。
  - [電卓アプリ](https://github.com/rin5uron/ios-style-calculator): iOS電卓の基本的な機能とデザインをクローンしました。
...
これらの記録は学習の進捗を可視化し、継続的な改善を促進するために活用する。
<br>
## 🔧 開発環境
- macOS
...
### 現在の学習フェーズ
- 電卓アプリの完成と実装
- ITパスポート試験対策の最終段階（5月30日受験予定）
- JavaScript実践スキルの向上
- レスポンシブデザイン技術のマスター

### 次のステップ
電卓アプリ第二フェーズ（高度な演算機能追加）の実装と、ITパスポート試験合格に向けた仕上げの勉強を進めます。
...
| 日付 | 合計時間 | 主な学習内容 |
|------|----------|--------------|
| 5/18(日) | 6h15m | 電卓アプリ第一フェーズ完成、ITパスポートマネジメント、システム戦略 |
| 5/17(土) | 0h45m | ITパスポート過去問 |
...
| 日付 | 合計時間 | 主な学習内容 |
|------|----------|--------------|
| 5/16(金) | 0h15m | ITパスポート過去問 |
| 5/15(木) | 2h45m | 電卓アプリCSS実装,readme作成、ITパスポート過去問 |
| 5/14(水) | 2h15m | JavaScript概念復習＠gpt、ITパスポート技術戦略、ITパスポート過去問 |
| 5/13(火) | 2h15m | JavaScript概念復習＠gpt、ITパスポート経営戦略 |
| 5/12(月) | 5h00m | デモサイトハンバーガーメニュー調整、ITパスポートストラテジ分野、関数問題、if文復習 |
| 5/10(土) | 2h30m | ITパスポート関数問題、100日サイト構成、デモページ最終調整 |

**週間総学習時間: 13h45m**

【2025/05/03-05/09】（前々週）
...
#### 週間所感
今週は電卓アプリの第一フェーズ完成とITパスポートの学習に焦点を当てました。特に経営戦略やシステム戦略の理解を深め、実践的な過去問に取り組むことで試験対策を進めました。電卓アプリは基本機能とUIが完成し、JavaScript学習の成果を実感できました。
<br>
<br>
# 🎯 このリポジトリで作成した演習・制作物
