...
## 学習成果
このリポジトリで作成した[演習・制作物](#-このリポジトリで作成した演習制作物)と[実施プロジェクト](#-実施プロジェクト)にまとめています。
...
## 完成画面
![自己紹介ページ完成画像](images/htmlcss/2025-03-25-self-intro.png)
...
[→ 技術仕様の詳細はこちら（仕様書：spec.md）](./spec.md)
