...
## 概要
SQLインジェクションとXSSについて学んだので、実践的に学習できるページを作りました。サイバー攻撃体験ページとして堅い用語を勉強できながらおしゃれでユーモアあるサイトを目指しました。
ターゲット：IT用語に馴染みのない人、IT用語を勉強中の人
目的　　　：SQLインジェクションとXSSについて実践的に理解する
