## 【2025/04/30】(11:00-12:30) 電卓アプリプロセス②
...
## 【2025/04/27】(09:00-11:30) カウンターアプリの改善
...
### メモ 📌
- デザインの一貫性がユーザビリティに大きく影響する
- ChatGPT Proからの提案を参考にするとUIの質が向上した
- 細部へのこだわりが全体の印象を大きく左右することを実感
...
### 学んだこと 📚
- SWOT分析の実践的な活用方法
  - 強み(Strengths)・弱み(Weaknesses)・機会(Opportunities)・脅威(Threats)の4象限
  - 内部環境と外部環境の視点からの分析
- PPM（プロダクト・ポートフォリオ・マネジメント）の概念
  - 花形(Star)・金のなる木(Cash Cow)・問題児(Question)・負け犬(Dog)
- バリューチェーン分析の基本
