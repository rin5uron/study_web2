...
### 学んだこと 📚
- ユーザー体験を向上させるUIデザインの原則
- CSSボックスモデルの応用テクニック
- ChatGPT Proの効果的な活用方法
...
### メモ 📌
- ChatGPT Proでは具体的なコード例を示すと効率的に学習できる
- UIデザインはシンプルさと機能性のバランスが重要
...
## 【2025/04/27】(17:00-18:00) 電卓アプリのHTML作成とJavaScript学習

### 完了したこと ✅
- 電卓アプリのHTML基本構造の作成
- JavaScriptのイベントリスナーについて学習
...
## 【2025/04/27】電卓アプリのHTML構造修正

### 完了したこと ✅
- 電卓アプリのHTML構造の修正
  - `<head>`と`<body>`タグの正しい配置
  - 重複タグの削除
  - ビューポートの設定修正
- アクセシビリティの改善
  - ボタンに`aria-label`を追加
...
### メモ 📌
- HTMLの構造を正しく設定することで、アクセシビリティと保守性が向上
- ビューポートの設定は、モバイル対応に重要な役割を果たす



## 【2025/04/27】(09:00-11:30) カウンターアプリの改善とChatGPT Pro活用

### 完了したこと ✅
- カウンターアプリプロジェクトの完了
- CursorとChatGPTで利用可能なAIの種類と特徴を整理
- AIの使い分けポイントの明確化
- 学習内容をITword.mdに記録

### 学んだこと 📚
[AIの種類と特徴について](ITword.md#aiの種類と特徴)
